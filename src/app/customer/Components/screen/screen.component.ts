...
export class ScreenComponent implements OnInit
{
  ...
  movieTitle:string = "Captain America: The Winter Soldier";
    ...
    ngOnInit()
    {
        ...
        collectionSnapshots(this.service.getAll(this.movieId,this.time)).pipe(
            map((seats) => {
              return seats.map((s) => {
    ...
    showTicket()
    {
        this.router.navigate(['/ticket',this.movieId,this.time]);
    }
    ...
    pushtoreserved()
    {
            ...
            {
                this.seat.id = i;
                this.service.addNewDocumentWithSpecificID(this.seat, this.movieId,this.time)
                    // .then(() => {
                    // alert("added")});
            }
